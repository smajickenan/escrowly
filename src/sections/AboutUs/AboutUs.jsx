            ...
            <div className="container">
                <div className="row sm-direction-column sm-mb-30">
                    ...
                    <div className="col">
                        ...
                        >
                            Escrowly is a crypto escrow system that serves as an unbiased third party protecting high-value assets until all parties meet the stipulated agreement. Our blockchain engine provides trustworthy crypto escrow deals powered by smart contracts.
                        </motion.p>
                        <Button
                            url="/get-started"
                            text="Get Started"
