                            ...
                            <div className="col col-1">
                                <div className="footer-social">
                                    ...
                                    <ul className="footer-social-icons">
                                        <li><a href="https://www.instagram.com/escrowlyholdings/" target="_blank"><img src="/img/social-icon-instagram.svg" alt="" /></a></li>
                                        <li><a href="#facebook"><img src="/img/social-icon-facebook.svg" alt="" /></a></li>
                                        <li><a href="https://www.youtube.com/@Escrowly" target="_blank"><img src="/img/social-icon-youtube.svg" alt="" /></a></li>
                                        <li><a href="https://x.com/escrowly" target="_blank"><img src="/img/social-icon-twitter.svg" alt="" /></a></li>
                                        <li><a href="https://www.linkedin.com/company/escrowly/" target="_blank"><img src="/img/social-icon-linkedin.svg" alt="" /></a></li>
                                    </ul>
